...
impl From<DbRenderJob> for RenderJob {
    fn from(value: DbRenderJob) -> Self {
        ...
        Self {
            ...
            transcode_frame_end_override: value.transcode_frame_end_override,
            fps: value.fps,
            ...
            shadow_resolution_scale_override: value.shadow_resolution_scale_override,
...
impl RenderJob {
    pub fn new(
        ...
        Self {
            ...
            transcode_frame_start_override: None,
            transcode_frame_end_override: None,
            fps: None,
            blend_file,
            blender_executable,
            output_path,
            output_format,
            render_mode,
            shadow_resolution_scale_override: None,
